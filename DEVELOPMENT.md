...
```bash
git remote add encore encore://syntax9-futuristic-landing-page-x53i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/syntax9-futuristic-landing-page-x53i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/syntax9-futuristic-landing-page-x53i/settings/integrations/github)
